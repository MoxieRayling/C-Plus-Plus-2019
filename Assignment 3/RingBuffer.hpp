...
public:
    ...
    _RBIterator& operator=(const _RBIterator<T, P, R>& pattern)
    {
        ...
        m_ptr = pattern.m_ptr;
	    return this;
        // *** Replace this with your code (6 marks)
    }

    Reference operator*() const
    {
        return *m_ptr;
        // *** Replace this with your code (2 marks)
    }
    ...
    {
	    return nullptr;  
        // *** Replace this with your code (0 marks)
    }
    ...
    _RBIterator& operator++()
    {
	    ...
	    return *this;// m_rb->stepForward(m_ptr,1);
        // *** Replace this with your code (4 marks)
    }

    _RBIterator operator++(int)
    {
        _RBIterator prev = _RBIterator(m_rb,m_ptr);
        m_ptr = m_rb->stepForward(m_ptr,1);
	    return prev;  
        // *** Replace this with your code (6 marks)
    }
    ...
    _RBIterator operator+(difference_type n)
    {
        _RBIterator result = _RBIterator(m_rb,m_rb->stepForward(m_ptr,n));
	    return result;  
        // *** Replace this with your code (4 marks)
    }
    ...
    {
	    return m_ptr-rhs.m_ptr;  
        // *** Replace this with your code (14 marks)
    }

    Reference operator[](difference_type n)
    {
	    return *static_cast<T*>(m_rb->stepForward(m_ptr, n)); 
        // *** Replace this with your code (2 marks)
    }
private:
...
public:
    ...
    {
	    return const_iterator(this,m_begin); // *** Replace this with your code (2 marks)
    }
    ...
    {
	    return const_iterator(this,m_end);  // *** Replace this with your code (2 marks)
    }
    ...
    {
		T& ref = *m_begin;
	    return ref; // *** Replace this with your code (2 marks)
    }
    ...
    {
		if(stepForward(m_end,1)==m_begin){
    ...
    {
	    return m_end - m_begin; // *** Replace this with your code (2 marks)
    }
private:
    ...
    Ptr stepForward(Ptr ptr, std::ptrdiff_t steps) const
    {
        ...
        return &m_buffer[pos + steps%size];
        */
		return &m_buffer[ptr-m_base+steps%capacity()];
		...
		const RingBuffer<T>& r)
{
    ...
    _RBIterator lit = l.begin();
    _RBIterator rit = r.begin();
    while(lit != l.end()){
        if(*lit!=*rit)
            same = false;
        lit++;
    ...
    // *** Replace this with your code (22 marks)
}
